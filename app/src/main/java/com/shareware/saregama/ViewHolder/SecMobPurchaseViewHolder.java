...
public class SecMobPurchaseViewHolder extends  RecyclerView.ViewHolder implements
    ...
    public SecMobPurchaseViewHolder(View itemView) {
        super(itemView);
    ...
    public void onCreateContextMenu(ContextMenu contextMenu, View view, ContextMenu.ContextMenuInfo contextMenuInfo) {
       ...
       // contextMenu.add(0,0,getAdapterPosition(), Common.UPDATE);
        ...
        contextMenu.add(0,1,getAdapterPosition(),"Add To Seller");
    }
}
