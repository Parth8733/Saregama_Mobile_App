...
public class upComingMobileForm extends AppCompatActivity {
   ...
   // FirebaseRecyclerAdapter<InquiryModel, InquiryViewHolder> adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_up_coming_mobile_form);
        database = FirebaseDatabase.getInstance();
        sellerViewList = database.getReference("Seller");
        inquiryViewList = database.getReference("UpMobileInquiry");
        ...
        recyclerView.addOnItemTouchListener(new RecyclerItemClickListener(upComingMobileForm.this, recyclerView, new RecyclerItemClickListener.OnItemClickListener() {
            @Override
            ...
            public void onLongItemClick(View view, int position) {
                ...
                PopupMenu popup = new PopupMenu(upComingMobileForm.this,view);
        ...
        filterButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                final AlertDialog.Builder alertDialog = new AlertDialog.Builder(upComingMobileForm.this);
                alertDialog.setTitle("Filter Details");
                alertDialog.setMessage("Select model for filtering data");
                LayoutInflater layoutInflater = upComingMobileForm.this.getLayoutInflater();
                ...
                alertDialog.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        if (modellist.equals(modellistarray.get(0))) {
                            Toast.makeText(upComingMobileForm.this, "Select Particular Model", Toast.LENGTH_SHORT).show();
        ...
        getpdfAllbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (dataofSeller.isEmpty()) {
                    Toast.makeText(upComingMobileForm.this, "Select particular date!!!", Toast.LENGTH_SHORT).show();
                } else {
                    if (ContextCompat.checkSelfPermission(upComingMobileForm.this,
                            android.Manifest.permission.WRITE_EXTERNAL_STORAGE)
                            != PackageManager.PERMISSION_GRANTED) {

                        // Permission is not granted
                        // Should we show an explanation?
                        if (ActivityCompat.shouldShowRequestPermissionRationale(upComingMobileForm.this,
                                android.Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
                            // Show an explanation to the user *asynchronously* -- don't block
                            // this thread waiting for the user's response! After the user
                            // sees the explanation, try again to request the permission.
                            Toast.makeText(upComingMobileForm.this, "Grant the permission for Storage !!", Toast.LENGTH_SHORT).show();
                        } else {
                            // No explanation needed; request the permission
                            ActivityCompat.requestPermissions(upComingMobileForm.this,
                        ...
                        final ProgressDialog pd = new ProgressDialog(upComingMobileForm.this);
                                    ...
                                    if (modellist!="") {
                                        inquiryViewList.orderByChild("date").equalTo(sendDate).addListenerForSingleValueEvent(new ValueEventListener() {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                ...
                                                Toast.makeText(upComingMobileForm.this, "if ma aave che", Toast.LENGTH_LONG).show();
                                        ...
                                        inquiryViewList.orderByChild("date").equalTo(sendDate).addListenerForSingleValueEvent(new ValueEventListener() {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                ...
                                                Toast.makeText(upComingMobileForm.this, String.valueOf(dataofSeller.size()), Toast.LENGTH_SHORT).show();
                                                createPDFAll(dataofSeller);
                                                pd.dismiss();
                                            }
...
//                                sendDate = String.valueOf(simpleDateFormatMain.parse(dateEtd.getText().toString()));
            ...
            public void onClick(View view) {
                ...
                etdStartingDate.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        new DatePickerDialog(upComingMobileForm.this, date, myCalendar
        ...
        path = Environment.getExternalStorageDirectory().getAbsolutePath() + "/Saregama/UpComingInquiryFormPDF";
        dir = new File(path);
        if (!dir.exists()) {
            dir.mkdirs();
        }
        ...
        findDateBtn.setOnClickListener(new View.OnClickListener() {
            ...
            //    Toast.makeText(upComingMobileForm.this, dateEtd.getText().toString(), Toast.LENGTH_SHORT).show();
        ...
        if (Common.isConnectedToInternet(getBaseContext())) {
           // Toast.makeText(this, formattedDate, Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(upComingMobileForm.this, "Please check your connection", Toast.LENGTH_SHORT).show();
            return;
        }
    }
    ...
    private void loadSellerListFromTo1(String startdate, String enddate, final String selectedModel) {
        ...
        inquiryViewList.orderByChild("date").startAt(startDate).endAt(endDate).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                Toast.makeText(upComingMobileForm.this, String.valueOf(inquiryList.size()), Toast.LENGTH_SHORT).show();
                Radapter = new MyInquiryAdapter(upComingMobileForm.this,inquiryList,inquiryListKey);
                LinearLayoutManager mLayoutManager = new LinearLayoutManager(upComingMobileForm.this);
    ...
    private void detailDataFetchModel() {
        ...
        inquiryViewList.orderByChild("date").startAt(startdate1).endAt(enddate1).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                ArrayAdapter<String> spinnerAdapter = new ArrayAdapter<>(upComingMobileForm.this,android.R.layout.simple_spinner_item, modellistarray);
    ...
    private void showUpdateDialog(final String key, final InquiryModel item) {
        ...
        alertDialog.setPositiveButton("YES", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                Toast.makeText(upComingMobileForm.this, "Values Updated", Toast.LENGTH_SHORT).show();
                if (!flag) {
                    if (dateEtd.getText().toString().isEmpty())
                        loadSellerViewList(formattedDate2);
                    else
        ...
        getPdfBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    Toast.makeText(upComingMobileForm.this, "hey " + e, Toast.LENGTH_SHORT).show();
                    e.printStackTrace();
                } catch (DocumentException e) {
                    Toast.makeText(upComingMobileForm.this, "bye " + e, Toast.LENGTH_SHORT).show();
                    e.printStackTrace();
                }
            }
        });
            ...
            public void onClick(View view) {
                if (ContextCompat.checkSelfPermission(upComingMobileForm.this,
                    ...
                    if (ActivityCompat.shouldShowRequestPermissionRationale( upComingMobileForm.this,
                        ...
                        // this thread waiting for the user's response! After the user
                        // sees the explanation, try again to request the permission.
                        Toast.makeText(upComingMobileForm.this, "Grant the permission for Call !!", Toast.LENGTH_SHORT).show();
                    } else {
                        // No explanation needed; request the permission
                        ActivityCompat.requestPermissions( upComingMobileForm.this,
