...
public class UpcomingMobile extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_upcoming_mobile);
        brand1 = (Spinner)findViewById(R.id.newmobile_inq_model);
        submit1 = (Button)findViewById(R.id.finalpayment);
        buyname1 = (EditText)findViewById(R.id.newmobile_inq_name);
        buyadd1 = (EditText)findViewById(R.id.newmobile_inq_add);
        mobnum1 = (EditText)findViewById(R.id.newmobile_inq_mob);
        comment1 = (EditText)findViewById(R.id.newmobile_inq_comment);
        compname1 = (Spinner) findViewById(R.id.newmobile_inq_brand);
        mobcolor1 = (Spinner) findViewById(R.id.newmobile_inq_color);
        mobprice1 = (EditText)findViewById(R.id.newmobile_inq_price);
        sellername1 = (EditText)findViewById(R.id.newmobile_inq_sellname);
        ...
        if (brandlist1 != null && brandlist1.size()!=0) {
            ...
            ArrayAdapter<String> spinnerAdapter1 = new ArrayAdapter<>(UpcomingMobile.this, android.R.layout.simple_spinner_item, brandlist1);
        ...
        if (modellist1 != null&& modellist1.size()!=0) {
            ...
            ArrayAdapter<String> spinnerAdapter2 = new ArrayAdapter<>(UpcomingMobile.this, android.R.layout.simple_spinner_item, modellist1);
        ...
        if (colorlist1!=null&&colorlist1.size()!=0) {
            ...
            ArrayAdapter<String> spinnerAdapter3 = new ArrayAdapter<>(UpcomingMobile.this, android.R.layout.simple_spinner_item, colorlist1);
        ...
        company = database.getReference("UpMobileBrand");
        company.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                ArrayAdapter<String> spinnerAdapter = new ArrayAdapter<>(UpcomingMobile.this,android.R.layout.simple_spinner_item, brandlist1);
        ...
        compname1.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long l) {
                ...
                company = database.getReference("UpMobileModel");
                company.addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        modellist1.clear();
                        ...
                        ArrayAdapter<String> spinnerAdapter = new ArrayAdapter<>(UpcomingMobile.this,android.R.layout.simple_spinner_item, modellist1);
                        spinnerAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        ...
        submit1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    Toast.makeText(UpcomingMobile.this, "Select Brand ", Toast.LENGTH_LONG).show();
                }else if (modelnamelist1.equals("Select Model:"))
                {
                    Toast.makeText(UpcomingMobile.this, "Select Model ", Toast.LENGTH_LONG).show();
                }else if (colorslist1.equals("Select Color:"))
                {
                    Toast.makeText(UpcomingMobile.this, "Select Color ", Toast.LENGTH_LONG).show();
                ...
                {
                    database = FirebaseDatabase.getInstance();
                    company = database.getReference("UpMobileInquiry");
                    ...
                    if (sellerModel!=null)
                    {
                        ...
                        Toast.makeText(UpcomingMobile.this, "Data Entry Successfully !!!!", Toast.LENGTH_LONG).show();
                        Intent i = new Intent(UpcomingMobile.this,MainPage.class);
        ...
        if (brandname1.equals("Select Brand: "))
        {
            ...
            company.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    ArrayAdapter<String> spinnerAdapter = new ArrayAdapter<>(UpcomingMobile.this,android.R.layout.simple_spinner_item, colorlist1);
                    spinnerAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
