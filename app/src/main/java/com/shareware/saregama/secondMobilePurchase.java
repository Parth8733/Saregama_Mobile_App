...
public class secondMobilePurchase extends AppCompatActivity {
    ...
    EditText etdbuyeraddress, etdbuyername, etdcontactnumber, etdmobile, etdcolorTv, etdieminumber, etddateTv, etdprice, etdsellername, etdcharger,etdheadphone,etdbilldate;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_second_mobile_purchase);
        ...
        recyclerView.addOnItemTouchListener(new RecyclerItemClickListener(secondMobilePurchase.this, recyclerView, new RecyclerItemClickListener.OnItemClickListener() {
            @Override
            ...
            public void onLongItemClick(View view, int position) {
                ...
                PopupMenu popup = new PopupMenu(secondMobilePurchase.this,view);
        ...
        getpdfAllbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (dataofSeller.isEmpty()) {
                    Toast.makeText(secondMobilePurchase.this, "Select particular date!!!", Toast.LENGTH_SHORT).show();
                } else {
                    if (ContextCompat.checkSelfPermission(secondMobilePurchase.this,
                            android.Manifest.permission.WRITE_EXTERNAL_STORAGE)
                            != PackageManager.PERMISSION_GRANTED) {

                        // Permission is not granted
                        // Should we show an explanation?
                        if (ActivityCompat.shouldShowRequestPermissionRationale(secondMobilePurchase.this,
                                android.Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
                            // Show an explanation to the user *asynchronously* -- don't block
                            // this thread waiting for the user's response! After the user
                            // sees the explanation, try again to request the permission.
                            Toast.makeText(secondMobilePurchase.this, "Grant the permission for Storage !!", Toast.LENGTH_SHORT).show();
                        } else {
                            // No explanation needed; request the permission
                            ActivityCompat.requestPermissions(secondMobilePurchase.this,
                        ...
                        final ProgressDialog pd = new ProgressDialog(secondMobilePurchase.this);
        ...
        fromToBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                final AlertDialog.Builder alertDialog = new AlertDialog.Builder(secondMobilePurchase.this);
                alertDialog.setTitle("Find Details");
                alertDialog.setMessage("Enter From and To Date");
                LayoutInflater layoutInflater = secondMobilePurchase.this.getLayoutInflater();
                ...
                etdStartingDate.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        new DatePickerDialog(secondMobilePurchase.this, date, myCalendar
        ...
        path = Environment.getExternalStorageDirectory().getAbsolutePath() + "/Saregama/SecMobPurchaseFormPDF";
        dir = new File(path);
        if (!dir.exists()) {
            dir.mkdirs();
        }
        ...
        findDateBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //      Toast.makeText(secondMobilePurchase.this, dateEtd.getText().toString(), Toast.LENGTH_SHORT).show();
        ...
        //    Toast.makeText(this, formattedDate, Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(secondMobilePurchase.this, "Please check your connection", Toast.LENGTH_SHORT).show();
            return;
        }
    }
    ...
    private void loadSellerListFromTo(String startdate, String enddate) {
        ...
        inquiryViewList.orderByChild("date").startAt(startDate).endAt(endDate).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                Toast.makeText(secondMobilePurchase.this, String.valueOf(secondMobPurchaseArrayList.size()), Toast.LENGTH_SHORT).show();
                Radapter = new MySecMobileAdapter(secondMobilePurchase.this,secondMobPurchaseArrayList,secondMobPurchaseKey);
                LinearLayoutManager mLayoutManager = new LinearLayoutManager(secondMobilePurchase.this);
   ...
   private void showUpdateDialog(final String key, final SecondMobPurchase item) {
        ...
        View add_menu_layout = layoutInflater.inflate(R.layout.update_secmobpurchase_design_layout, null);
        ...
        etdbilldate = add_menu_layout.findViewById(R.id.etdbillDate);
        etdcharger = add_menu_layout.findViewById(R.id.etdchareger);
        etdheadphone = add_menu_layout.findViewById(R.id.etdheadphone);
        etdieminumber = add_menu_layout.findViewById(R.id.etdiemiNumber);
        ...
        etdbilldate.setText(item.getBilldate());
        etdieminumber.setText(item.getIemiNumber());
        etdcharger.setText(item.getCharger());
        etdheadphone.setText(item.getHeadphone());
        ...
        alertDialog.setPositiveButton("yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                item.setBilldate(etdbilldate.getText().toString());
                item.setIemiNumber(etdieminumber.getText().toString());
                item.setCharger(etdcharger.getText().toString());
                item.setHeadphone(etdheadphone.getText().toString());
                inquiryViewList.child(key).setValue(item);
                Toast.makeText(secondMobilePurchase.this, "Values Updated", Toast.LENGTH_SHORT).show();
                dialogInterface.dismiss();
                if (!flag) {
                    if (dateEtd.getText().toString().isEmpty())
                        loadSecMobPurchaseList();
                    else
                        loadSecMobPurchaseViewList(dateEtd.getText().toString());
                }
                else
                    loadSellerListFromTo(startDate,endDate);
            ...
            public void onClick(View view) {
                if (ContextCompat.checkSelfPermission(secondMobilePurchase.this,
                    ...
                    if (ActivityCompat.shouldShowRequestPermissionRationale( secondMobilePurchase.this,
                        ...
                        // this thread waiting for the user's response! After the user
                        // sees the explanation, try again to request the permission.
                        Toast.makeText(secondMobilePurchase.this, "Grant the permission for Call !!", Toast.LENGTH_SHORT).show();
                    } else {
                        // No explanation needed; request the permission
                        ActivityCompat.requestPermissions( secondMobilePurchase.this,
...
//create table
    ...
    private void deleteAndAddToSeller(String key, SecondMobPurchase item) {
